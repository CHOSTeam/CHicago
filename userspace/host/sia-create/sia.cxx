...
static bool alloc_file_entry_int(fstream &file, const string &name, uint16_t flags, uint64_t off) {
...
static uint64_t alloc_file_entry(fstream &file, const string &name, uint16_t flags) {
...
static bool file_create(fstream &hfile, sia_header_t &header, uint8_t num, const string &spath, const string &dpath,
                        uint16_t flags) {
	sia_file_t file;
	sia_file_t dir;
	uint64_t doff;
